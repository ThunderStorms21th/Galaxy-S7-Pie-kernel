...
static gpu_dvfs_info gpu_dvfs_table_default[] = {
	{806, 850000, 0, 98, 100, 1, 0, 1794000, 413000, 1378000, CPU_MAX},
	{754, 850000, 0, 96,  99, 2, 0, 1794000, 413000, 1378000, CPU_MAX},
/*	{728, 850000, 0, 96,  99, 2, 0, 1794000, 413000, 1586000, CPU_MAX}, */
	{702, 850000, 0, 96,  99, 3, 0, 1794000, 413000, 1378000, CPU_MAX},
	{650, 800000, 0, 94,  97, 5, 0, 1794000, 413000, 1378000, 1872000},	/* org 1586000, 1560000 */
	{600, 800000, 0, 78,  95, 9, 0, 1539000, 413000, 1170000, CPU_MAX},
	{546, 800000, 0, 78,  95, 1, 0, 1144000, 413000, 1170000, CPU_MAX},
	{419, 800000, 0, 78,  82, 1, 0, 1144000, 267000,  754000, CPU_MAX},
...
static gpu_attribute gpu_config_attributes[GPU_CONFIG_LIST_END] = {
	...
	{GPU_PMQOS_MIF_MAX_CLOCK, 1794000},	/* org 1539000 */
	{GPU_PMQOS_MIF_MAX_CLOCK_BASE, 806},	/* org 650 */
	{GPU_CL_DVFS_START_BASE, 546},		/* org 702 */
	{GPU_DEBUG_LEVEL, DVFS_WARNING},
	{GPU_TRACE_LEVEL, TRACE_ALL},
#ifdef CONFIG_MALI_DVFS_USER
	{GPU_UDVFS_ENABLE, 1},
#endif
	{GPU_MO_MIN_CLOCK, 260},		/* org 419 */
	{GPU_BOOST_EGL_MIN_LOCK, 2080000},	/* org 1872000 */
};
